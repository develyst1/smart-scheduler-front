...
describe("§3 — the doors and the bodies", () => {
  ...
  it("copy: booking +22 · calendar +2 · bookingType +1 — both languages; the snapshot is 50", () => {
    expect(ACTION_KEYS_SNAPSHOT.length).toBe(59) /* TASK-427 + TASK-429 + TASK-432: budget-view, other-cancel-all, coach-rate */; // + TASK-402's four camp keys + TASK-407's teacher-leave + TASK-412's parent-archive
