...
const en = {
  ...
  users: {
    ...
    // REQ-097 (TASK-407) — the user ↔ teacher link
    teacherLink: "Teacher",
    teacherLinkHint: "Linked, this account sees only its own calendar: check in and report leave, nothing else.",
    teacherNone: "None (staff account)",
  ...
  // REQ-095 Stage 3a / SPEC-082 (TASK-402) — Balance camp. Every refusal sentence is the server's; credit in units ⇒ days + ½.
  camp: {
    card: "Camp",
    cardTitle: "Camp — {name}",
    noPackages: "No camp package yet.",
    kind_FULL: "Full day",
    kind_HALF: "Half day",
    plan_FULL_WEEK: "Full week (5 days)",
    plan_DAILY: "Daily",
    halfFull: "Full",
    ...
    goRedeem: "Redeem on the Camp page",
    sellCamp: "Sell a camp",
    sellTitle: "Sell a camp package",
    sell: "Sell",
    soldOk: "Camp package sold — {n} days planned",
    days: "Days",
    price: "Price (incl. VAT)",
    note: "Note",
    firstWeek: "Plan the first week now",
    week: "Week",
    openWeek: "Open a week",
    openWeekTitle: "Open a camp week",
    editWeek: "Edit",
    editWeekTitle: "Edit {name}",
    weekName: "Week name",
    startDate: "First day",
    endDate: "Last day",
    capacity: "Capacity",
    capacityHint: "Kids per day; empty = no cap",
    capacityLine: "cap {n}",
    teachers: "Teachers",
    ...
    marked_CANCELLED: "Day cancelled — credit returned",
    redeemInto: "Redeem into this week",
    redeemTitle: "Redeem into {week}",
    redeem: "Plan {n} days",
    redeemedOk: "{n} days planned",
    ...
    // REQ-095 §11 (TASK-419) — the week editor: the window + the per-day table
  ...
  teacherLeave: {
    ...
    date: "Date",
    sessions: "My sessions that day",
    noSessions: "No sessions of yours on this day.",
    reason: "Reason",
  ...
  otherSeries: {
    ...
    notFound: "This series was not found.",
    heads: "{n} people",
    counts: "{live} live · {pending} pending · {attended} attended · {cancelled} cancelled",
    editHeader: "Edit",
    swapPrimary: "Swap",
    ...
    addDates: "Add dates",
    addDatesHint: "The series already has {n} dates; a date already live is refused by the server.",
    addDatesConfirm: "Add {n} dates",
    datesAdded: "{n} dates added",
    confirmAll: "Confirm all ({n} pending)",
    confirmedAll: "{confirmed} confirmed · {skipped} skipped",
    cancelAll: "Cancel all",
    cancelAllTitle: "Cancel the whole series?",
    cancelAllBody: "{live} live rows will be cancelled; {kept} attended rows are kept. The coaches are told by the system.",
    cancelAllConfirm: "Yes, cancel the series",
    cancelledAll: "{n} rows cancelled",
  ...
  calendar: {
    ...
    // REQ-095 (TASK-395) — the OTHER kind tags
    ...
    campSwapConfirm: "Swap",
    campSwappedOk: "{from} → {to} — the day's block moved",
    campOpenRoster: "Open the camp roster",
  ...
  booking: {
    ...
    // REQ-095 Stage 1 (TASK-395) — ECA · Free · KOL: kind, head count, rate per teacher, the series
    otherKind: "Kind",
    otherKindPick: "Pick a kind",
    otherKind_ECA: "ECA",
    otherKind_FREE: "Free",
    otherKind_KOL: "KOL",
    otherKind_CAMP: "Camp (the week's block)",
    otherHeadCount: "Head count",
    otherRate: "Rate per teacher (฿)",
    otherRateHint: "Stored for the backoffice; not posted here.",
    otherRatePrimary: "primary",
    otherSeries: "Create series",
    otherSeriesTitle: "Create a series of Other schedules",
    otherSeriesNote: "Note",
    otherSeriesDates: "Dates",
    otherSeriesCount: "{n} dates ticked — one booking each, all or nothing",
    otherSeriesCreate: "Create {n}",
    otherSeriesCreatedOk: "{n} schedules created",
    ...
    walkInSeat: "Walk-in seat",
    walkInInto: "Walk-in seat into {name} — teacher, date and time are the group's; one session, paid like a private hour",
    walkInChip: "1h",
  ...
  course: {
    ...
    // REQ-095 §13 (TASK-421) — DUO = one course, two kids
    kindPrivate: "Private",
    kindDuo: "DUO (two kids)",
    coStudent: "Second child",
    duoSameChild: "The two children must be different.",
    classRate: "Teaching rate (ค่าสอน)",
    classRateHint: "Per session, baht — the DUO course's rate (the price is the DUO card's).",
    classRateMoveHint: "Per session, baht — changes the course's rate; sent only if you change it.",
    duoTag: "DUO",
    rateLine: "Rate {baht} ฿ / session",
    rateEdit: "Edit rate",
    rateSavedOk: "Rate saved",
    // REQ-095 §13.3 (TASK-424) — the per-session override vs the course default
    sessionRate: "This session's rate",
    sessionRateHint: "Leave blank = the course's default (฿{baht}); sent only if you change it.",
    rateDefault: "default",
  ...
  voucher: {
    ...
    used: "Used up",
    usable: "Usable",
    // REQ-103 (TASK-440) — the whole-voucher cancel. The chip reads the server's `status` + frozen `remaining`.
    endedChip: "Ended · {n}h left",
    cancel: "Cancel voucher",
    endTitle: "Cancel this voucher?",
    endLine: "Cancel the voucher for {student} — this removes the {n} upcoming session(s). It cannot be undone.",
    endKept: "{n}h left — kept for the customer",
    endAlready: "This voucher has already been cancelled.",
    endConfirm: "Cancel the voucher",
    endDone: "Voucher cancelled",
    colStudent: "Student",
  ...
  people: {
    ...
    archiveParentBody: "The whole family leaves every working list: every student is archived with the parent and their LINE link is cleared. History and money stay. A family with sessions ahead cannot be archived — the server will say how many. You can restore them any time.",
    archiveParentConfirm: "Yes, archive the family",
    parentArchivedOk: "{name} archived — {n} students with them, {line} LINE link(s) cleared",
    restoreParentTitle: "Restore {name}?",
    restoreParentBody: "The parent and their students come back to every working list. The LINE link is NOT restored — the family links again through the register page.",
    restoreParentConfirm: "Yes, restore",
    parentRestoredOk: "{name} restored — {n} students with them",
    archivedParents: "Archived families ({n})",
    archivedWithStudents: "{n} students: {names}",
    // REQ-099 (TASK-415) — the birthday filter
    birthday: "Birthday",
    birthdayHint: "Students born in these months, or those with no date of birth on file. The list follows the server's order.",
    birthdayFrom: "From",
    birthdayTo: "To",
    birthdayNoDob: "No DOB recorded",
    birthdayClear: "Clear",
    birthdayFound: "{n} students",
    birthdayEmpty: "No students match",
    birthdayYear: "Year",
    birthdayAnyYear: "any",
...
const th: typeof en = {
  ...
  users: {
    ...
    teacherLink: "ครู",
    teacherLinkHint: "ผูกแล้ว บัญชีนี้จะเห็นเฉพาะตารางของตัวเอง เช็คอินและแจ้งลาได้เท่านั้น",
    teacherNone: "ไม่ผูก (บัญชีแอดมิน)",
    teacherLine: "ครู: {name}",
    superAdmin: "Super admin",
    admin: "Admin",
    you: "(คุณ)",
    ...
    moreActions: "คำสั่งเพิ่มเติมของ {name}",
  ...
  camp: {
    card: "แคมป์",
    cardTitle: "แคมป์ — {name}",
    noPackages: "ยังไม่มีแพ็กเกจแคมป์",
    kind_FULL: "เต็มวัน",
    kind_HALF: "ครึ่งวัน",
    plan_FULL_WEEK: "เต็มสัปดาห์ (5 วัน)",
    plan_DAILY: "รายวัน",
    halfFull: "เต็ม",
    ...
    goRedeem: "ไปใช้เครดิตที่หน้าแคมป์",
    sellCamp: "ขายแคมป์",
    sellTitle: "ขายแพ็กเกจแคมป์",
    sell: "ขาย",
    soldOk: "ขายแพ็กเกจแคมป์แล้ว — วางแผน {n} วัน",
    days: "จำนวนวัน",
    price: "ราคา (รวม VAT)",
    note: "หมายเหตุ",
    firstWeek: "วางแผนสัปดาห์แรกเลย",
    week: "สัปดาห์",
    openWeek: "เปิดสัปดาห์",
    openWeekTitle: "เปิดสัปดาห์แคมป์",
    editWeek: "แก้ไข",
    editWeekTitle: "แก้ไข {name}",
    weekName: "ชื่อสัปดาห์",
    startDate: "วันแรก",
    endDate: "วันสุดท้าย",
    capacity: "จำนวนรับ",
    capacityHint: "เด็กต่อวัน; เว้นว่าง = ไม่จำกัด",
    capacityLine: "รับ {n}",
    teachers: "ครู",
    ...
    mark: "บันทึก",
    marked_ATTENDED: "บันทึกว่ามาแล้ว",
    marked_ABSENT: "บันทึกว่าขาดแล้ว",
    marked_CANCELLED: "ยกเลิกวันแล้ว — คืนเครดิต",
    redeemInto: "ใช้เครดิตเข้าสัปดาห์นี้",
    redeemTitle: "ใช้เครดิตเข้า {week}",
    redeem: "วางแผน {n} วัน",
    redeemedOk: "วางแผนแล้ว {n} วัน",
    ...
    windowStart: "เริ่มกี่โมง",
    windowEnd: "เลิกกี่โมง",
  ...
  otherSeries: {
    ...
    notFound: "ไม่พบตารางชุดนี้",
    heads: "{n} คน",
    counts: "ใช้งาน {live} · รอยืนยัน {pending} · มาเรียน {attended} · ยกเลิก {cancelled}",
    editHeader: "แก้ไข",
    swapPrimary: "สลับ",
    ...
    addDates: "เพิ่มวัน",
    addDatesHint: "ชุดนี้มี {n} วันแล้ว วันที่มีอยู่แล้วระบบจะปฏิเสธ",
    addDatesConfirm: "เพิ่ม {n} วัน",
    datesAdded: "เพิ่มแล้ว {n} วัน",
    confirmAll: "ยืนยันทั้งหมด (รอ {n})",
    confirmedAll: "ยืนยัน {confirmed} · ข้าม {skipped}",
    cancelAll: "ยกเลิกทั้งชุด",
    cancelAllTitle: "ยกเลิกทั้งชุด?",
    cancelAllBody: "จะยกเลิก {live} คาบที่ใช้งานอยู่ คาบที่มาเรียนแล้ว {kept} คาบคงไว้ ระบบจะแจ้งครูให้",
    cancelAllConfirm: "ใช่ ยกเลิกทั้งชุด",
    cancelledAll: "ยกเลิกแล้ว {n} คาบ",
  ...
  calendar: {
    ...
    campSwapConfirm: "สลับ",
    campSwappedOk: "{from} → {to} — ย้ายบล็อกของวันแล้ว",
    campOpenRoster: "เปิดรายชื่อแคมป์",
    otherKindTag_ECA: "ECA",
  ...
  booking: {
    ...
    otherKind: "ประเภท",
    otherKindPick: "เลือกประเภท",
    otherKind_ECA: "ECA",
    otherKind_FREE: "ฟรี",
    otherKind_KOL: "KOL",
    otherKind_CAMP: "แคมป์ (บล็อกของสัปดาห์)",
    otherHeadCount: "จำนวนคน",
    otherRate: "ค่าตอบแทนครู (฿)",
    otherRateHint: "บันทึกไว้ให้ backoffice — ยังไม่ลงบัญชีที่นี่",
    otherRatePrimary: "ครูหลัก",
    otherSeries: "สร้างเป็นชุด",
    otherSeriesTitle: "สร้างตารางอื่นๆ เป็นชุด",
    otherSeriesNote: "หมายเหตุ",
    otherSeriesDates: "วันที่",
    otherSeriesCount: "เลือกแล้ว {n} วัน — สร้างวันละ 1 รายการ ทั้งหมดหรือไม่สร้างเลย",
    otherSeriesCreate: "สร้าง {n} รายการ",
    otherSeriesCreatedOk: "สร้างแล้ว {n} รายการ",
    ...
    walkInInto: "ที่นั่ง walk-in ในกลุ่ม {name} — ครู วัน และเวลาเป็นของกลุ่ม หนึ่งคาบ คิดเงินแบบรายชั่วโมง",
    walkInChip: "1h",
  ...
  course: {
    ...
    kindPrivate: "เดี่ยว",
    kindDuo: "DUO (2 คน)",
    coStudent: "นักเรียนคนที่ 2",
    duoSameChild: "นักเรียนสองคนต้องไม่ใช่คนเดียวกัน",
    classRate: "ค่าสอน",
    classRateHint: "ต่อคาบ (บาท) — ค่าสอนของคอร์ส DUO (ราคาขายมาจากแพ็กเกจ DUO)",
    classRateMoveHint: "ต่อคาบ (บาท) — แก้ค่าสอนของคอร์ส ส่งเฉพาะเมื่อเปลี่ยน",
    duoTag: "DUO",
    rateLine: "ค่าสอน {baht} ฿ / คาบ",
    rateEdit: "แก้ค่าสอน",
    rateSavedOk: "บันทึกค่าสอนแล้ว",
    sessionRate: "ค่าสอนคาบนี้",
    sessionRateHint: "เว้นว่าง = ใช้ค่าเริ่มต้นของคอร์ส (฿{baht}) ส่งเฉพาะเมื่อเปลี่ยน",
  ...
  voucher: {
    ...
    used: "ใช้หมด",
    usable: "ใช้ได้",
    // REQ-103 (TASK-440) — ยกเลิกบัตรชั่วโมงทั้งใบ ป้ายอ่านจาก `status` ของเซิร์ฟเวอร์ + ยอด `remaining` ที่ถูกแช่ไว้
    endedChip: "ยกเลิกแล้ว · เหลือ {n} ชม.",
    cancel: "ยกเลิกบัตรชั่วโมงทั้งใบ",
    endTitle: "ยกเลิกบัตรชั่วโมงใบนี้?",
    endLine: "ยกเลิกบัตรชั่วโมงของ {student} — จะลบคาบที่จองไว้ล่วงหน้า {n} คาบ ทำแล้วย้อนกลับไม่ได้",
    endKept: "เหลือ {n} ชม. — เก็บไว้ให้ลูกค้า",
    endAlready: "บัตรชั่วโมงใบนี้ถูกยกเลิกไปแล้ว",
    endConfirm: "ยกเลิกบัตรชั่วโมง",
    endDone: "ยกเลิกบัตรชั่วโมงแล้ว",
    colStudent: "นักเรียน",
    colTotal: "ชั่วโมงรวม",
  ...
  people: {
    ...
    archiveParentConfirm: "ใช่ เก็บทั้งครอบครัว",
    parentArchivedOk: "เก็บ {name} แล้ว — นักเรียน {n} คนไปด้วย ล้างไลน์ {line} บัญชี",
    restoreParentTitle: "คืนสถานะ {name}?",
    restoreParentBody: "ผู้ปกครองและนักเรียนกลับมาทุกรายการที่ใช้งาน การเชื่อมไลน์จะไม่กลับมา — ครอบครัวต้องเชื่อมใหม่ผ่านหน้าลงทะเบียน",
    restoreParentConfirm: "ใช่ คืนสถานะ",
    parentRestoredOk: "คืนสถานะ {name} แล้ว — นักเรียน {n} คนกลับมาด้วย",
    archivedParents: "ครอบครัวที่เก็บแล้ว ({n})",
    archivedWithStudents: "นักเรียน {n} คน: {names}",
    birthday: "วันเกิด",
    birthdayHint: "นักเรียนที่เกิดในช่วงเดือนนี้ หรือที่ยังไม่มีวันเกิดในระบบ รายการเรียงตามที่เซิร์ฟเวอร์ส่งมา",
    birthdayFrom: "ตั้งแต่เดือน",
    birthdayTo: "ถึงเดือน",
    birthdayNoDob: "ยังไม่มีวันเกิด",
    birthdayClear: "ล้าง",
    birthdayFound: "นักเรียน {n} คน",
    birthdayEmpty: "ไม่มีนักเรียนที่ตรงเงื่อนไข",
    birthdayYear: "ปี (ค.ศ.)",
    birthdayAnyYear: "ทุกปี",
