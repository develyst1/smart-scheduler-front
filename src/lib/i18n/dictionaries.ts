...
const en = {
  ...
  users: {
    title: "Users",
    noAccess: "Only a super admin can manage users.",
    create: "Add user",
    ...
    colCreated: "Created",
    username: "Username",
    usernameHint: "3–40 characters: lowercase letters, digits, . _ -",
    ...
    superAdminToggle: "Super admin (can manage users)",
    ...
    resetBody: "Set a new password for this user. They will use it from their next login.",
    resetConfirm: "Set new password",
    disable: "Disable",
    enable: "Enable",
    disableTitle: "Disable {name}?",
    disableBody: "They will be signed out on their next request and cannot log in until enabled again. Nothing else changes.",
    createdOk: "{name} added",
    savedOk: "User saved",
  ...
  settings: {
    ...
    empty: "No configurable rules yet",
    default: "Default",
    ...
    valueLabel: "New value ({unit})",
    saved: "Setting saved",
    savedDesc: "{label} is now {value} {unit}",
    resetDone: "Reset to default",
    resetDoneDesc: "{label} is back to the default of {value} {unit}",
  ...
  booking: {
    ...
    // ── SPEC-070 / REQ-078 (TASK-226) — the อื่นๆ booking form. Thai is REQ-078 §User-facing wording VERBATIM;
    //    English is the equivalent, not a translation of the Thai back again.
    otherTeachers: "Teachers",
    otherTeachersHint: "One or more — an Other booking may need several",
    otherTitle: "Title",
    otherTitlePlaceholder: "e.g. Team meeting, Rink maintenance",
    ...
    otherChargeSourceAmount: "Type an amount",
    otherChargeSourceItem: "Pick a catalogue item",
    otherAmountLabel: "Amount (฿)",
    // ⚠️ Every price in this product is VAT-INCLUSIVE. Saying so on the field is the whole guard: the first
    // person to type a net figure silently misstates a month, and nothing downstream can detect it.
    otherAmountHint: "The final amount the customer pays — VAT included",
    otherItemLabel: "Catalogue item",
    otherItemPlaceholder: "Select an item",
    // 🔴 The empty state. An empty dropdown with no words is indistinguishable from a broken endpoint — this
    // sentence is the difference between "nothing to pick yet" and "someone should debug the API".
    otherItemEmpty: "No catalogue items yet — create one in the backoffice first.",
    otherItemEmptyHint: "You can still charge by typing an amount.",
    otherConsume: "Deduct from course / voucher",
    otherConsumeNeedsStudent: "Select a student first — a deduction needs one",
    otherConsumePick: "Course / voucher to deduct from",
    otherConsumeNone: "This student has no usable course or voucher",
    errOtherNoTeacher: "Select at least one teacher.",
    errOtherNoTitle: "Please enter a title",
    errOtherAmount: "Please enter a valid amount",
    errOtherNoItem: "Select a catalogue item, or type an amount instead.",
    errOtherConsumeNoStudent: "Select a student first — a deduction needs one.",
    errOtherNoEntitlement: "Select the course or voucher to deduct from.",
  ...
  som: {
    title: "SOM dashboard",
    subtitle: "A single snapshot of customers, activities, growth and demographics.",
    ...
    // 2. activity share
    sportShareTitle: "Activity share",
    // 3. new vs renewing
  ...
  overview: {
    title: "Overview",
    subtitle: "Operations, teaching load, customers and market — one screen, one time range.",
    scopeRange: "{from} – {to}",
    ...
    custom: "Custom",
    zonePulse: "Pulse",
    zonePulseHint: "headline KPIs & trend for the range",
    zoneOps: "Operations",
    zoneOpsHint: "how the load splits across teachers, types & badges",
    zoneBiz: "Business & market",
    zoneBizHint: "customer base, growth & demographics",
    trendTitle: "Bookings vs attended",
    trendBooked: "Booked",
    trendAttended: "Attended",
    statusTitle: "Booking status",
    zoneRevenue: "Revenue & value",
    zoneRevenueHint: "sales, average course value & top spenders",
    courseSizeTitle: "Active courses by size",
    activityShareTitle: "Activity share",
    branchTitle: "Sessions by branch",
    hoursUnit: "hr",
    unitSessions: "sessions",
    unitPeople: "people",
    unitCourses: "courses",
    unitVouchers: "vouchers",
    unitItems: "items",
    subBaseStructure: "Customer base structure",
    existingTitle: "Existing courses",
    activeCourse: "Active courses",
    activeVoucher: "Active vouchers",
    existingTotal: "Total (course + voucher)",
    previous3M: "Previous 3M (bring back)",
    newVsRemainingTitle: "New vs renewing",
    newFirstTrial: "New (first trial)",
    newCourse: "New course",
    renewing: "Renewing",
    typeActivityTitle: "Activity count per registration type",
    colRegType: "Registration type",
    colTotal: "Total",
    totalRevenue: "Total sales",
    salesByCategory: "Sales by category",
    salesByActivity: "Sales by activity",
    avgPerCourseTitle: "Avg course value by activity",
    topCustomersTitle: "Top customers by spend",
...
const th: typeof en = {
  ...
  users: {
    title: "ผู้ใช้งาน",
    noAccess: "เฉพาะ super admin เท่านั้นที่จัดการผู้ใช้งานได้",
    create: "เพิ่มผู้ใช้",
    createTitle: "เพิ่มผู้ใช้งาน",
    colUsername: "ชื่อผู้ใช้",
    colDisplayName: "ชื่อที่แสดง",
    colRole: "สิทธิ์",
    colStatus: "สถานะ",
    colCreated: "สร้างเมื่อ",
    username: "ชื่อผู้ใช้",
    usernameHint: "3–40 ตัวอักษร: a-z ตัวเล็ก ตัวเลข . _ -",
    ...
    superAdminToggle: "Super admin (จัดการผู้ใช้ได้)",
    superAdmin: "Super admin",
    admin: "Admin",
    you: "(คุณ)",
    statusEnabled: "ใช้งานอยู่",
    statusDisabled: "ปิดใช้งาน",
    edit: "แก้ไข",
    editTitle: "แก้ไข {name}",
    resetPassword: "ตั้งรหัสผ่านใหม่",
    resetTitle: "ตั้งรหัสผ่านใหม่ให้ {name}",
    resetBody: "ตั้งรหัสผ่านใหม่ให้ผู้ใช้นี้ จะใช้ได้ตั้งแต่การเข้าสู่ระบบครั้งถัดไป",
    resetConfirm: "ตั้งรหัสผ่านใหม่",
    disable: "ปิดใช้งาน",
    enable: "เปิดใช้งาน",
    disableTitle: "ปิดใช้งาน {name}?",
    disableBody: "ผู้ใช้จะถูกออกจากระบบในคำขอถัดไป และเข้าสู่ระบบไม่ได้จนกว่าจะเปิดใช้งานอีกครั้ง ข้อมูลอื่นไม่เปลี่ยน",
    createdOk: "เพิ่ม {name} แล้ว",
    savedOk: "บันทึกผู้ใช้แล้ว",
  ...
  settings: {
    ...
    valueLabel: "ค่าใหม่ ({unit})",
    saved: "บันทึกการตั้งค่าแล้ว",
    savedDesc: "{label} เป็น {value} {unit} แล้ว",
    resetDone: "คืนค่าเริ่มต้นแล้ว",
    resetDoneDesc: "{label} กลับเป็นค่าเริ่มต้น {value} {unit}",
  ...
  calendar: {
    ...
    studentSearch: "ค้นหานักเรียน",
    studentSearchPlaceholder: "พิมพ์ชื่อนักเรียน",
    empty: "ว่าง",
  ...
  booking: {
    ...
    // ── SPEC-070 / REQ-078 (TASK-226) — คำในตารางของ REQ-078 §User-facing wording **ตรงตามต้นฉบับ** ──
    otherTeachers: "ครู",
    otherTeachersHint: "เลือกได้มากกว่า 1 คน — รายการอื่นๆ อาจต้องใช้ครูหลายคน",
    otherTitle: "ชื่อรายการ",
    otherTitlePlaceholder: "เช่น ประชุมทีม, ปิดปรับปรุงลาน",
    ...
    otherChargeSourceAmount: "ระบุจำนวนเงินเอง",
    otherChargeSourceItem: "เลือกจากแคตตาล็อก",
    otherAmountLabel: "จำนวนเงิน (฿)",
    // ⚠️ ราคาทุกอย่างในระบบนี้ **รวม VAT แล้ว** — ถ้าไม่บอกตรงนี้ คนแรกที่กรอกยอดก่อน VAT จะทำให้ยอดทั้งเดือนผิดโดยไม่มีใครรู้
    otherAmountHint: "ยอดสุทธิที่ลูกค้าจ่ายจริง — รวม VAT แล้ว",
    otherItemLabel: "รายการจากแคตตาล็อก",
    otherItemPlaceholder: "เลือกรายการ",
    // 🔴 dropdown ว่างเปล่าโดยไม่มีข้อความ แยกไม่ออกจาก API พัง — ประโยคนี้คือสิ่งที่ทำให้แยกออก
    otherItemEmpty: "ยังไม่มีรายการในแคตตาล็อก — สร้างที่หลังบ้านก่อน",
    otherItemEmptyHint: "ยังคิดเงินได้โดยระบุจำนวนเงินเอง",
    otherConsume: "ตัดสิทธิ์จากคอร์ส / Voucher",
    otherConsumeNeedsStudent: "เลือกนักเรียนก่อน — การตัดสิทธิ์ต้องมีนักเรียน",
    otherConsumePick: "คอร์ส / Voucher ที่จะตัดสิทธิ์",
    otherConsumeNone: "นักเรียนคนนี้ไม่มีคอร์สหรือวอยเชอร์ที่ใช้ได้",
    errOtherNoTeacher: "กรุณาเลือกครูอย่างน้อย 1 คน",
    errOtherNoTitle: "กรุณาระบุชื่อรายการ",
    errOtherAmount: "กรุณาระบุจำนวนเงินให้ถูกต้อง",
    errOtherNoItem: "กรุณาเลือกรายการจากแคตตาล็อก หรือระบุจำนวนเงินเอง",
    errOtherConsumeNoStudent: "เลือกนักเรียนก่อน — การตัดสิทธิ์ต้องมีนักเรียน",
    errOtherNoEntitlement: "กรุณาเลือกคอร์สหรือวอยเชอร์ที่จะตัดสิทธิ์",
  ...
  course: {
    ...
    emptyStatus: "ไม่มีคอร์สที่{status}",
  ...
  som: {
    title: "แดชบอร์ด SOM",
    subtitle: "ภาพรวมลูกค้า กิจกรรม การเติบโต และข้อมูลประชากร ในสแนปช็อตเดียว",
    ...
    sportShareTitle: "สัดส่วนกิจกรรม",
  ...
  overview: {
    title: "ภาพรวม",
    subtitle: "operation, ภาระสอน, ลูกค้า และตลาด — จอเดียว ช่วงเวลาเดียว",
    scopeRange: "{from} – {to}",
    generatedAt: "ข้อมูล ณ {time}",
    today: "วันนี้",
    thisWeek: "สัปดาห์นี้",
    ...
    custom: "กำหนดเอง",
    zonePulse: "ภาพรวม",
    zonePulseHint: "ตัวเลขสรุปและแนวโน้มในช่วงที่เลือก",
    zoneOps: "การดำเนินงาน",
    zoneOpsHint: "การกระจายงานตามครู ประเภท และ badge",
    zoneBiz: "ธุรกิจและตลาด",
    zoneBizHint: "ฐานลูกค้า การเติบโต และข้อมูลประชากร",
    trendTitle: "จอง vs มาเรียน",
    trendBooked: "จอง",
    trendAttended: "มาเรียน",
    statusTitle: "สถานะการจอง",
    zoneRevenue: "รายได้และมูลค่า",
    zoneRevenueHint: "ยอดขาย ค่าเฉลี่ยต่อคอร์ส และลูกค้าที่ใช้จ่ายสูงสุด",
    courseSizeTitle: "คอร์สที่ใช้งานตามขนาด",
    activityShareTitle: "สัดส่วนกิจกรรม",
    branchTitle: "คาบตามสาขา",
    hoursUnit: "ชม.",
    unitSessions: "คาบ",
    unitPeople: "คน",
    unitCourses: "คอร์ส",
    unitVouchers: "ใบ",
    unitItems: "รายการ",
    subBaseStructure: "โครงสร้างฐานลูกค้า",
    existingTitle: "คอร์สที่มีอยู่",
    activeCourse: "คอร์สที่ใช้งาน",
    activeVoucher: "วอยเชอร์ที่ใช้งาน",
    existingTotal: "รวม (คอร์ส+วอยเชอร์)",
    previous3M: "ลูกค้า 3 เดือน (ดึงกลับ)",
    newVsRemainingTitle: "ลูกค้าใหม่ vs ต่ออายุ",
    newFirstTrial: "ใหม่ (ทดลองครั้งแรก)",
    newCourse: "เปิดคอร์สใหม่",
    renewing: "ต่อคอร์ส (renewing)",
    typeActivityTitle: "จำนวนกิจกรรมต่อรูปแบบการลงทะเบียน",
    colRegType: "รูปแบบการลงทะเบียน",
    colTotal: "รวม",
    totalRevenue: "ยอดขายรวม",
    salesByCategory: "ยอดขายตาม category",
    salesByActivity: "ยอดขายตามกิจกรรม",
    avgPerCourseTitle: "ค่าเฉลี่ยต่อคอร์ส (ตามกิจกรรม)",
    topCustomersTitle: "ลูกค้าที่ใช้จ่ายสูงสุด",
    rowRange: "{from}–{to} จาก {total}",
    colCustomer: "ลูกค้า",
    colActivity: "กิจกรรม",
    colCourses: "คอร์ส",
    colVisits: "เข้าเรียน",
    colSpend: "ยอดใช้จ่ายรวม",
  },
