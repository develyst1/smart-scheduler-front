...
describe("§1 — ONE gate, everywhere", () => {
  ...
  it("the snapshot: 46 keys in 8 areas; every key a site uses exists; exactly two keys have no FE site", () => {
  ...
  it("the sweep: 68 key literals across 30 files (the count is the deliverable's honesty check against the BE's list)", () => {
